...
import com.LibreriaMV1704.repositorios.ClienteRepositorio;
import com.LibreriaMV1704.utilidades.ValidacionPassword;
...
public class ClienteService implements UserDetailsService {
    ...
    public Cliente cargarClienteS(String nombreForm, String apellidosForm, String dniForm, String telefonoForm,
        ...
        try {
            validarDatos(null, nombreForm, apellidosForm, dniForm, telefonoForm, emailForm);
    ...
    public Cliente editarClienteS(Integer idForm, String nombreForm, String apellidosForm, String dniForm,
        ...
        try {
            ...
            validarDatos(cliente, nombreForm, apellidosForm, dniForm, telefonoForm, emailForm);
            cliente.setNombre(nombreForm);
            cliente.setApellidos(apellidosForm);
            cliente.setDni(dniForm);
            cliente.setTelefono(telefonoForm);
    ...
    public void validarDatos(Cliente cliente, String nombreForm, String apellidosForm, String dniForm, String telefonoForm,
            String emailForm) throws Exception {
        int contadorArrobas = 0;
        Cliente clienteXEmail;
        try {
            ...
            clienteXEmail = clienteRepositorio.buscarClienteXEmailR(emailForm);
            if (clienteXEmail != null && !clienteXEmail.getId().equals(cliente.getId())) {
                throw new ErrorServicio("El email ingresado ya existe y corresponde a otro usuario.");
            }
